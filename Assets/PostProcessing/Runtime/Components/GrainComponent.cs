namespace UnityEngine.PostProcessing
{
    public sealed class GrainComponent : PostProcessingComponentRenderTexture<GrainModel>
    {
        ...
        public override void Prepare(Material uberMaterial)
        {
            ...
            NewMethod(settings, grainMaterial);
        ...
        private void NewMethod(GrainModel.Settings settings, Material grainMaterial)
        {
            NewMethod1(settings, grainMaterial);
        }

        private void NewMethod1(GrainModel.Settings settings, Material grainMaterial)
        {
            Graphics.Blit(source: null, dest: m_GrainLookupRT, mat: grainMaterial, pass: settings.colored ? 1 : 0);
        }
    }
}
